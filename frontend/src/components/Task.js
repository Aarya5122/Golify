...
const Task = ({body}) => {
    return(
        <div className="inline-block m-2 flex">
            <p 
            className="p-1 max-w-sm border bg-violet-200 border-t-violet-500 border-b-violet-500 border-l-violet-500 border-r-transparent rounded-l p-0.5">
                {(body)?body:"NJdbbd  ajsdhuiagd sadbiagd dkygdbas fdfjdbf dkj duhdygabd hgdyugfagv dagdyufvd ahdsuitagdba dhgdgavd"}
            </p>
            <button 
            className="border border-red-500 rounded-r p-0.5 active:bg-red-300 pl-2 pr-1">
